...
OUTPUT_FILE = "data_sekolah_smk.xlsx"
...
# =====================================
# DETEKSI JENIS PENDIDIKAN OTOMATIS
# =====================================
if "/dikmen/" in BASE_URL:
    LINK_FILTER = "/dikmen/"
else:
    LINK_FILTER = "/dikdas/"
            ...
            for i in range(total_rows):
                ...
                try:
                    ...
                    if link_elem.count() > 0:
                        link_npsn = link_elem.first.get_attribute("href")
